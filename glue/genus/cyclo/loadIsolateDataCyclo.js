// list the sequences in source ncbi-refseqs-cyclo
var listSeqResult = glue.command(["list", "sequence", "-w", "source.name = 'ncbi-refseqs-cyclo'"]);
...
_.each(seqIds, function(seqId) {
    ...
    glue.inMode("sequence/ncbi-refseqs-cyclo/"+seqId, function() {
